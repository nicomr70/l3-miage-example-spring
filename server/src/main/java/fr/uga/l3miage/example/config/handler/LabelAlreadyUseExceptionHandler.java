...
@ControllerAdvice
@Slf4j
public class LabelAlreadyUseExceptionHandler {
     ...
     */
    @ExceptionHandler(LabelAlreadyExistRestException.class)
    public ResponseEntity<ErrorResponse> handle(HttpServletRequest httpServletRequest, Exception exception){
        LabelAlreadyExistRestException ex = (LabelAlreadyExistRestException) exception;
