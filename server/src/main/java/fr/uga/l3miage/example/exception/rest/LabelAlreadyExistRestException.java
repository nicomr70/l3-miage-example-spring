 ...
 */
@Getter
public class LabelAlreadyExistRestException extends RuntimeException {
    private final String description;

    public LabelAlreadyExistRestException(String message, String description) {
        super(message);
        this.description = description;
    }

    public LabelAlreadyExistRestException(String message, String description, Throwable cause) {
        super(message, cause);
        this.description = description;
    }
